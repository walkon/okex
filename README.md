okex
====
[![Go Reference](https://pkg.go.dev/badge/github.com/walkon/okex.svg)](https://pkg.go.dev/github.com/walkon/okex)
[![GitHub go.mod Go version of a Go module](https://img.shields.io/github/go-mod/go-version/walkon/okex.svg)](https://github.com/walkon/okex)
[![GoReportCard example](https://goreportcard.com/badge/github.com/walkon/okex)](https://goreportcard.com/report/github.com/walkon/okex)
[![GitHub license](https://img.shields.io/github/license/walkon/okex.svg)](https://github.com/walkon/okex/blob/main/LICENSE)
[![GitHub release](https://img.shields.io/github/release/walkon/okex.svg)](https://GitHub.com/walkon/okex/releases/)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
[![CI](https://github.com/walkon/okex/actions/workflows/main.yml/badge.svg)](https://github.com/walkon/okex/actions/workflows/main.yml)
[![CodeQL](https://github.com/walkon/okex/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/walkon/okex/actions/workflows/codeql-analysis.yml)
[![AutoRelease](https://github.com/walkon/okex/actions/workflows/release.yml/badge.svg)](https://github.com/walkon/okex/actions/workflows/release.yml)
...
```bash
go get github.com/walkon/okex@v1.1.4-alpha
```
...
import (
  ...
  ws_public_requests "github.com/walkon/okex/requests/ws/public"
  "log"
)
...
* To receive websocket events you can choose [RawEventChan](/api/ws/client.go#L25)
  ...
  channels. [More info](https://github.com/walkon/okex/wiki/Handling-WS-events) 
